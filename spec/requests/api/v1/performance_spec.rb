...
RSpec.describe "Api::V1::Performance", type: :request do
  ...
  describe "GET /api/v1/performance" do
    it "returns read-only performance statistics JSON" do
      travel_to Time.zone.local(2026, 6, 3, 12, 0, 0) do
        create_trade(profit_loss: 50, closed_at: Time.current)

        get api_v1_performance_path, params: { from: "2026-06-03", to: "2026-06-03", daily_days: 1 }
